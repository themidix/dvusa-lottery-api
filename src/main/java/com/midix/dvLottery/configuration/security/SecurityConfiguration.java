...
import com.midix.dvLottery.configuration.filter.JWTAuthenticationFilter;
import com.midix.dvLottery.configuration.filter.JWTAuthorizationFilter;
...
public class SecurityConfiguration {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200","http://localhost:3001","http://localhost:8081"));
